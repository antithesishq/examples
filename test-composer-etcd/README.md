# How to use the Test Composer

This example demonstrates how to use the [Test Composer](https://antithesis.com/docs/test_templates/) framework to write test workloads that exercise a 3-node [etcd](https://etcd.io/) cluster.

The workloads provide examples of how to use [parallel](https://antithesis.com/docs/test_templates/test_composer_reference/#parallel-driver), [serial](https://antithesis.com/docs/test_templates/test_composer_reference/#serial-driver-command), [eventually](https://antithesis.com/docs/test_templates/test_composer_reference/#eventually-command) and [finally](https://antithesis.com/docs/test_templates/test_composer_reference/#finally-command) test drivers, written in different languages (Python, Go, Java, Rust, Bash).
...
An example of the resulting [triage report](https://antithesis.com/docs/reports/#the-triage-report) can be found [here](https://public.antithesis.com/report/f6oh7KZ6Pchcv9nGfo5oL9IU/lCbpXJUfNwfknLazqvV3mWD3CM37l89raJTdSXNBh3c.html).
...
To request a container registry and credentials, contact us at support@antithesis.com.
...
This section gives an overview of how this example defines test commands and uses the Antithesis language-specific SDKs.
...
This repository includes the use of Antithesis's [Python](https://antithesis.com/docs/using_antithesis/sdk/python/), [Go](https://antithesis.com/docs/using_antithesis/sdk/go/), [Java](https://antithesis.com/docs/using_antithesis/sdk/java/), and [Rust](https://antithesis.com/docs/using_antithesis/sdk/rust/) SDKs, to signal that the setup has completed, define assertions and handle randomness.

#### setupComplete

The ["setupComplete"](https://antithesis.com/docs/generated/sdk/python/antithesis/lifecycle.html#setup_complete) function signals that the system is ready to test. For example, in `entrypoint.py`: 
...
Randomness is key for autonomous testing, since we want the software to follow many, unpredictable execution paths. [The Antithesis SDKs](https://antithesis.com/docs/using_antithesis/sdk/#randomness) provide an easy interface to get structured random values while also providing valuable guidance to the Antithesis platform, which increases the efficiency of testing.
